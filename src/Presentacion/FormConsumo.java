   ...
   public static String cliente;
    ...
    void listar (String buscar){
        try {
            ...
            lblconsumo.setText("Consumo Total €. " + funcion.consumostotales);
        } catch (Exception e) {
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(30, 30, 30)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtidproducto, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtprecio_venta, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
                                            .addComponent(txtcantidad))))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtidconsumo, javax.swing.GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (txtidproducto.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Tienes que seleccionar un producto");
            btnbuscarproducto.requestFocus();
            return;
        }
        if (txtcantidad.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Tienes que ingresar una cantidad de consumo");
        ...
        if (accion.equals("guardar")){
            if (funcion.insertar(dts)){
                JOptionPane.showConfirmDialog(rootPane, "El consumo " + txtproducto.getText() + " del cliente "
                        + txtcliente.getText() + " se ha registrado correctamente");
                listar(idreserva);
                inhabilitar();
            }
        }
            ...
            if (funcion.editar(dts)){
                JOptionPane.showConfirmDialog(rootPane, "El consumo del cliente "
                        + txtcliente.getText() + " se ha modificado correctamente ");
                listar(idreserva);
                inhabilitar();
            }
        }
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (!txtidconsumo.getText().equals("")) {
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "¿Seguro que quieres eliminar el consumo?","Confirmar",2);
    ...
    private void btnbuscarproductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarproductoActionPerformed
        // TODO add your handling code here:
        FormVistaProducto formulario = new FormVistaProducto();
        formulario.toFront();
