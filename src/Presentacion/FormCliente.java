...
public class FormCliente extends javax.swing.JInternalFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtcodigo_cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(cbotipo_documento, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (txtnombre.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Tienes que ingresar un nombre de cliente");
            txtnombre.requestFocus();
            return;
        }
        if (txtprimer_apellido.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Tienes que ingresar el primer apellido para el cliente");
            txtprimer_apellido.requestFocus();
            return;
        }
        if (txtsegundo_apellido.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Tienes que ingresar el segundo apellido para el cliente");
            txtsegundo_apellido.requestFocus();
            return;
        }
        if (txtnum_documento.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Tienes que ingresar un número de documento para el cliente");
            txtnum_documento.requestFocus();
            return;
        }
        if (txtcodigo_cliente.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Tienes que ingresar un código para el cliente");
            txtcodigo_cliente.requestFocus();
            return;
        }

        BCliente dts = new BCliente();
        FCliente funcion = new FCliente();
        ...
        if (accion.equals("guardar")){
            if (funcion.insertar(dts)){
                JOptionPane.showConfirmDialog(rootPane, "El cliente se ha registrado correctamente");
                listar("");
                inhabilitar();
            }
        }
            ...
            if (funcion.editar(dts)){
                JOptionPane.showConfirmDialog(rootPane, "El cliente se ha editado correctamente");
                listar("");
                inhabilitar();
            }
        }
