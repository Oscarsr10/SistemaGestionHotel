...
public class BReserva {
    ...
    public BReserva(int idreserva, int idhabitacion, int idcliente, int idtrabajador, String tipo_reserva, Date fecha_reserva, Date fecha_llegada, Date fecha_salida, Double costo_alojamiento, String estado) {
